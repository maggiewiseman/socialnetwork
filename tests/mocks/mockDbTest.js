...
describe('getFriends test and  should return a list of friends (status pending or accepted) for a given user whether that user is the sender or the receiver', function() {
    ...
    it('should return 0 rows when the user id is 3 b/c the person with id 3 has 1 pending friendship for which he is the sender, one terminated friendship, and one cancelled friendship.',
...
// describe('getPosts tests', function() {
//     it('should return 0 rows when the user id is 3 b/c the person with id 3 has 1 pending friendship for which he is the sender, one terminated friendship, and one cancelled friendship.',
//
//         function() {
//             expect(mockDb.getFriends([3])).to.equal(0);
//         });
// });
